        ...
        <div className="flex-1 overflow-auto">
          <div className="p-6 pb-4 flex flex-col gap-6 shrink-0">
            ...
            <div className="flex flex-wrap items-center gap-6">
              {/* Cards */}
              <div className="bg-white rounded-2xl p-5 shadow-sm flex flex-col w-48 border-2 border-white hover:border-pink-200 transition-colors">
          ...
          <div className="px-6 pb-6 flex flex-col">
            <div className="bg-white rounded-3xl shadow-md flex flex-col overflow-hidden min-h-[60vh]">
              ...
              <div className="p-6 pb-3 flex justify-between items-center shrink-0">
              ...
              {/* Pagination */}
              <div className="p-5 px-6 border-t border-gray-100 flex justify-between items-center shrink-0">
